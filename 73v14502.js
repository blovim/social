...
function youtube_det(c, d, e, g) {
    $.ajax({
        ...
        b += '<div class="by_author"><a href="https://www.youtube.com/channel/' + d + '" target="_BLANK">' + a.items[0].snippet.channelTitle + '</a>' + _timeSince(new Date(a.items[0].snippet.publishedAt).getTime()) + ' | Numero de vistas ' + addCommas(viewc) + '</div></div>';
